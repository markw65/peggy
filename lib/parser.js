...
function peg$parse(input, options) {
  ...
  var peg$e39 = peg$otherExpectation("character class");
  ...
  var peg$e53 = peg$classExpectation([["0", "9"], "u", "x"], false, false);
  ...
  var peg$e59 = peg$otherExpectation("code block");
  ...
  var peg$f40 = function(digits) { return parseInt(digits, 10); };
  var peg$currPos = 0;
  var peg$savedPos = 0;
  ...
  function peg$parseGrammar() {
    ...
    s0 = peg$currPos;
    peg$parse__();
    s1 = peg$parseTopLevelInitializer();
    if (s1 !== peg$FAILED) {
      peg$parse__();
    } else {
      s1 = null;
  ...
  function peg$parsePrefixedExpression() {
    ...
    if (s1 !== peg$FAILED) {
      peg$parse__();
      s2 = peg$parseSuffixedExpression();
      if (s2 !== peg$FAILED) {
        peg$savedPos = s0;
        s0 = peg$f11(s1, s2);
      } else {
  ...
  function peg$parseCharacterClassMatcher() {
    ...
    if (input.charCodeAt(peg$currPos) === 91) {
      ...
      s2 = [];
      s3 = peg$parseClassCharacterRange();
      if (s3 === peg$FAILED) {
